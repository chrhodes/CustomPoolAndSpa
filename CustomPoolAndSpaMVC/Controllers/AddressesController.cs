...
namespace CustomPoolAndSpaMVC.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Street1,Street2,City,State,ZipCode,DateModified,DateCreated")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Street1,Street2,City,State,ZipCode,DateModified,DateCreated")] Address address)
        {
            if (ModelState.IsValid)
            {
